  ...
  if(isset($_REQUEST['action'])) {
     switch ($_REQUEST['action']) {
        case "delete": {
          ...
          $sqlSentence = "DELETE FROM clientes WHERE id='".$_REQUEST['id']."'";
        ...
        case "edit": {
          ...
          $fieldList = array("nombre","nif","direccion","cp","poblacion","pais","telefono","email","observaciones");
          $sqlSentence = "UPDATE clientes SET ";
        ...
        case "add": {
          ...
          $sqlSentence = "INSERT INTO clientes (nombre,nif,direccion,cp,poblacion,pais,telefono,email,observaciones) ";
          $sqlSentence.="VALUES (";
          ...
          if(mysqli_query($sqlConn,$sqlSentence)) {
              $sqlSentence = "SELECT * FROM clientes order by id";
      ...
      $sqlSentence = "SELECT * FROM clientes WHERE id!=1 order by id";
      $alldata = mysqli_query($sqlConn,$sqlSentence);
